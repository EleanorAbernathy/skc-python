...
def main():
    ...
    with open(join(dirname(abspath(__file__)),'../pickles/su2/gen-g16-1.pickle'), 'rb') as f: 
        begin_time = time.time()
    ...
    solovay_kitaev(H, 1, basic_approxes)
